...
describe Cinema::AncientMovie do
  subject { Cinema::AncientMovie.new('http://imdb.com/title/tt0043014/?ref_=chttp_tt_49', 'Sunset Blvd.','1950','USA','1950-08-25','Drama,Film-Noir','110 min','8.5','Billy Wilder','William Holden,Gloria Swanson,Erich von Stroheim') }
...
describe Cinema::ClassicMovie do
  ...
  subject { Cinema::ClassicMovie.new('http://imdb.com/title/tt0053291/?ref_=chttp_tt_111','Some Like It Hot','1959','USA','1959-03-29','Comedy','120 min','8.3','Billy Wilder','Marilyn Monroe,Tony Curtis,Jack Lemmon', collection) }
...
describe Cinema::ModernMovie do
  subject { Cinema::ModernMovie.load_from_csv('http://imdb.com/title/tt0169547/?ref_=chttp_tt_63|American Beauty|1999|USA|1999-10-01|Drama,Romance|122 min|8.4|Sam Mendes|Kevin Spacey,Annette Bening,Thora Birch') }
...
describe Cinema::NewMovie do
  subject { Cinema::NewMovie.load_from_csv('http://imdb.com/title/tt1305806/?ref_=chttp_tt_135|The Secret in Their Eyes|2009|Argentina|2010-05-21|Drama,Mystery,Thriller|129 min|8.3|Juan José Campanella|Ricardo Darín,Soledad Villamil,Pablo Rago') }
